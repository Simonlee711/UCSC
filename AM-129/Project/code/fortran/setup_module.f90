module problemsetup
  ...
  integer, save :: N    ! Number of grid points to use in the discretization
  real (dp), save :: alpha  ! Index ofnum_ Mathieu functions we are looking for
...
contains
  ...
  subroutine problemsetup_Init(inFile)
    ...
    call read_initFileReal(inFile,'alpha',alpha)
