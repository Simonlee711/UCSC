...
class City(object):
    ...
    def calculate_distances(self): 
        ...
        for city in list_of_cities:
            temp_dist = self.point_dist(self.x, self.y, city.x, city.y)
            self.distance_to[city.name] = temp_dist
...
def random_cities():
    ...
    46 = City('46', 75, 180)
    47 = City('47', 190, 190)
    48 = City('48', 250, 10)i = City('i', 60, 200)
    49 = City('49', 180, 190)
    50 = City('50', 100, 180)
    51 = City('51', 140, 180)
    52 = City('52', 20, 160)
    ...
    69 = City('69', 75, 180)
    70 = City('70', 190, 190)
    71 = City('71', 250, 10)i = City('i', 60, 200)
    72 = City('72', 180, 190)
    73 = City('73', 100, 180)
    74 = City('74', 140, 180)
    75 = City('75', 20, 160)
    ...
    98 = City('98', 20, 160)
    99 = City('99', 100, 160)
    100 = City('100', 140, 140)
    101 = City('101', 40, 120)
    102 = City('102', 100, 120)
    103 = City('103', 180, 100)
    104 = City('104', 60, 80)
    105 = City('105', 120, 80)
    106 = City('106', 180, 60)
    107 = City('107', 20, 40)
    ...
    app = App(n_generations=max_generations,pop_size=population_size, graph=True)
